  ...
  return (
    <div className="bg-white rounded-2xl p-5 shadow-sm">
      ...
      {(doctor?.licenseId || doctor?.licenseExpiry) && (
        <>
          <div className="text-[10px] text-gray-400  tracking-wide mb-2">Medical License</div>
      ...
      {specialties.length > 0 && (
        <>
          <div className="text-[10px] text-gray-400 tracking-wide mb-2">Specialties & Focus</div>
      ...
      {education?.school && (
        <>
          <div className="text-[10px] text-gray-400 tracking-wide mb-2">Education</div>
