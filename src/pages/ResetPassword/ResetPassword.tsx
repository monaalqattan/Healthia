      ...
      <main className="mx-auto flex w-full max-w-[1100px] flex-1 flex-col items-center justify-between gap-10 px-5 pt-[100px] pb-[60px] lg:flex-row">
        ...
        <div className="w-full max-w-[480px] flex-1">
          ...
          <div className="flex flex-col gap-3 rounded-[20px] border-[1.5px] border-[#1B7A4B] bg-[#F1F4F2] p-6 shadow-sm">
            <div className="flex items-center gap-2.5 text-base font-bold text-[#1a1a1a]">
              <svg className="h-5 w-5 stroke-[#1B7A4B]" viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <p className="text-[13.5px] leading-relaxed text-[#666]">
              Our support guides are standing by 24/7 to help you find your path back to wellness.
            </p>
            <a href="#" className="mt-1 inline-flex items-center gap-1.5 text-[13.5px] font-bold text-[#1B7A4B] transition-opacity hover:opacity-80">
              Contact Support
        ...
        <div className="flex w-full flex-1 justify-center lg:justify-end">
          <div className="flex w-full max-w-[460px] flex-col overflow-hidden rounded-[32px] bg-white pt-10 shadow-[0_12px_48px_rgba(0,0,0,0.05)]">
            <div className="flex flex-col gap-6 px-10 pb-8">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative flex items-center">
                  <svg className="absolute left-4 text-[#aaa]" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <input
                    ...
                    className={`w-full rounded-2xl border bg-[#F4F5F4] py-4 pr-4 pl-11 text-left text-sm transition-all outline-none ${
                      error && step === "email" ? "border-red-500" : "border-[#EBEBEB] focus:border-[#1B7A4B] focus:bg-white"
                  ...
                  <div className="relative flex flex-col items-end">
                    <input
                      ...
                      className={`w-full rounded-2xl border bg-[#F4F5F4] px-5 py-4 text-center text-lg font-bold tracking-[0.5em] outline-none ${
                        error ? "border-red-500" : "border-[#EBEBEB] focus:border-[#1B7A4B]"
                      }`}
                    />
                    <button
                      type="button"
              ...
              <button
                disabled={isLoading}
                className="flex items-center justify-center gap-2 rounded-2xl bg-[#156c40] py-4 text-[15px] font-bold text-white shadow-md transition-all hover:bg-[#115732] active:scale-[0.98] disabled:opacity-60"
                onClick={step === "email" ? handleSendLink : handleVerifyCode}
              >
                {isLoading ? "Please wait..." : step === "email" ? "Send Reset Link" : "Verify & Reset Password"}
              ...
              {/* Back Link */}
              <Link to="/login" className="flex items-center justify-center gap-1.5 text-center text-[13.5px] font-bold text-[#666] hover:text-[#1B7A4B]">
                <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <img src={resetImg} alt="Reset decoration" className="mt-auto h-[200px] w-full rounded-t-[32px] object-cover" />
          </div>
        </div>
      </main>
